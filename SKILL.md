...
22. **台词最高准则（7.1.4.1，违反则项目全部作废）**：台词压缩必须保留原来的意思、情绪、逻辑，台词必须跟时长相互匹配，台词+画面必须融洽衔接有画面感。只要违反这三条中的任意一条，**不是修改当前镜头，是整个项目全部作废——从有到无、从零开始、全部清除、全部不认**，必须从阶段0原文分级处理开始完整重新走一遍全流程，禁止照搬之前的分析、理解、蓝图、分镜。本准则凌驾于所有台词规则之上，是绝对的，没有妥协空间。
